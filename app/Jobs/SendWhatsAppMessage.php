...
class SendWhatsAppMessage implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        // Ambil nomor kelas numeric (kolom 'kelas' di tabel kelas), default 7
        $kelasNumber = data_get($u,'kelas.kelas',7);
        $kelasLabel  = $kelasNumber <= 6
            ? "Kelas {$kelasNumber}"
            : "Kelas Luar";

        $tgl = Carbon::now()->isoFormat('D MMMM YYYY');
