...
<body>
    ...
    <hr>
    <h3>Laporan Pengajuan Tabungan @if($exportOption == 'kelas') Kelas {{$kelasId}} @elseif($exportOption == 'semua') Semua Kelas @endif </h3>
        ...
        @endif
        <br>
        <p>Detail Pengajuan dari <span> {{ \Carbon\Carbon::parse($startDate)->format('d F Y') }} - {{ \Carbon\Carbon::parse($endDate)->format('d F Y') }}</span></p>
            ...
            <tbody>
                @foreach($pengajuans as $item)
                    <tr>
                        ...
                        @endif
                        <td>{{  number_format($item->tabungan->saldo) }}</td>
                        <td>{{  number_format($item->jumlah_penarikan) }}</td>
                        <td>{{ $item->status }}</td>
