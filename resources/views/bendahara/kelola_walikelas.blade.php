        ...
        <div class="card-body" style="margin-bottom: -20px">
            ...
            <div class="d-flex justify-content-between">
                ...
                <form action="/bendahara/kelola-walikelas" method="GET">
                    <div class="input-group">
                        {{-- <span class="input-group-text" id="basic-addon1"><i class="bi bi-search" style="margin-top: -7px"></i></span> --}}
            ...
            <form action="{{ route('walikelas.add') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group">
                            <input type="text" id="username-horizontal" class="form-control" name="username" placeholder="Nama" required>
                        </div>
                        <div class="col-md-4">
