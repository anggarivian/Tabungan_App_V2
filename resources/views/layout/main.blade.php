                ...
                <nav class="main-navbar">
                    <div class="container">
                        <ul>
                            ...
                            {{-- Pengajuan -------------------------------------------------------------------------------------------------------------------- --}}
                            @if( auth()->user()->roles_id == 2 )
                            <li class="menu-item {{ request()->is('bendahara/pengajuan*') ? 'active' : '' }}">
                                <a href="#" class='menu-link' style="margin-top: -3px">
                            ...
                            {{-- Laporan -------------------------------------------------------------------------------------------------------------------- --}}
                            @if( auth()->user()->roles_id == 1 )
                            <li class="menu-item {{ request()->is('kepsek/laporan*') ? 'active' : '' }}">
                                <a href="#" class='menu-link' style="margin-top: -3px">
                            ...
                            <li class="menu-item {{ request()->routeIs('walikelas.index') ? 'active' : '' }}">
                                <a href="{{ route ('walikelas.index')}}" class='menu-link' style="margin-top: -3px">
                            ...
                            <li class="menu-item {{ request()->routeIs('siswa.index') ? 'active' : '' }}">
                                <a href="{{ route ('siswa.index')}}" class='menu-link' style="margin-top: -3px">
